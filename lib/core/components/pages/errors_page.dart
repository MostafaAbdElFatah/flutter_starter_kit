...
class ErrorStatePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final messageAlign = centerTextsAndActions
        ? TextAlign.center
        : config.messageAlign;
    final titleStyle = config.titleColor.medium(fontSize: responsive.sp(25));
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(config.title.tr(), textAlign: titleAlign, style: titleStyle),
              10.spacingHeight,
              AutoSizeText(
                config.message.tr(),
