...
@LazySingleton(as: EnvironmentLocalDataSource)
class EnvironmentLocalDataSourceImpl implements EnvironmentLocalDataSource {
  ...
  EnvironmentLocalDataSourceImpl({
  ...
  @override
  get currentEnvironment  => _environmentConfigService.currentEnvironment;
  ...
  /// - [env]: The environment for which to get the auth config.
  @override
  AuthConfig getAuthConfigForEnvironment(env) => _environmentConfigService.getAuthConfigForEnvironment(env);
  ...
  Future<void> updateConfiguration(
    environment, {
    BaseUrlConfigModel? baseUrlConfig,
  }) => _environmentConfigService.updateConfiguration(
    environment,
